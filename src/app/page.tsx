...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Detectar localStorage corrompido: isInitialized=true mas sem dados
    if (isInitialized && useStore.getState().appointments.length === 0 && supabaseActive) {
      console.warn('[DASHBOARD] ⚠️ Detectado localStorage corrompido - resetando...');
